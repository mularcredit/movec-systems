    ...
    <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-emerald-500/30">
      ...
      <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl pt-20 animate-in fade-in slide-in-from-bottom-5 duration-1000">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-emerald-400 text-xs font-semibold uppercase tracking-widest mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            }} className="w-full sm:w-auto px-8 py-4 bg-white/10 hover:bg-white/15 text-white rounded-full font-medium transition flex items-center justify-center gap-2 backdrop-blur-md text-lg">
              Explore Platform
            </button>
          </div>
        </div>
      ...
      <div id="features" className="py-24 bg-slate-900 relative z-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">Manage your customers, payments, and network from one simple dashboard.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            
            {/* Feature 1 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/10 group">
            ...
            {/* Feature 2 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-blue-500/10 group">
            ...
            {/* Feature 3 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-purple-500/10 group">
            ...
            {/* Feature 4 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-amber-500/10 group">
            ...
            {/* Feature 5 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-cyan-500/10 group">
            ...
            {/* Feature 6 */}
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 p-8 rounded-3xl hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-rose-500/10 group">
      ...
      <footer className="border-t border-slate-800 py-10 text-center">
        <p className="text-slate-500 text-sm">© {new Date().getFullYear()} Movec Connect. All rights reserved.</p>
      </footer>
    </div>
  );
}
